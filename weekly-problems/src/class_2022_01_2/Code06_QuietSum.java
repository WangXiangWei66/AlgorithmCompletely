...
public class Code06_QuietSum {
    ...
    public static class SBTNode {
        ...
        public int size;//以当前节点为根的子树中“不同值”的节点总数
        public int all;//以当前节点为根的节点的总数
        public long sum;//以当前节点为根的所有节点值的和
        public SBTNode l;
        public SBTNode r;
    ...
    public static class SBTree {
        ...
        private SBTNode rightRotate(SBTNode cur) {
            int curCount = cur.all - (cur.l != null ? cur.l.all : 0) - (cur.r != null ? cur.r.all : 0);//当前节点的自身计数
