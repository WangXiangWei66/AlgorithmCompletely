...
public class Code01_SomeDPFromVT {
    ...
    public static int process1(int[][] stickers, int index, int restFunny, int restOffense) {
        ...
        int next2 = process1(stickers, index + 1, Math.max(0, restFunny - stickers[index][0]), Math.max(0, restOffense - stickers[index][1]));
    ...
    public static int process2(int[][] stickers, int index, int restFunny, int restOffense, int[][][] dp) {
        ...
        int p2 = Integer.MAX_VALUE;
        int next2 = process2(stickers, index + 1, Math.max(0, restFunny - stickers[index][0]), Math.max(0, restOffense - stickers[index][1]), dp);
