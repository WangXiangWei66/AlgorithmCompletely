...
public class Experiment {
    ...
    // 基尼系数公式：G = (1/(2n²μ)) * ΣΣ|x_i - x_j| （简化后为：总绝对差 / (2n * 总财富)）
    // 其中：n=人数，μ=平均财富，x_i=第i人的财富，ΣΣ是所有两两组合的绝对差之和
    public static double calculateGini(double[] wealth) {
        double sumOfAbsoluteDifference = 0;//两两财富的绝对差之和
        double sumOfWealth = 0;//总财富
